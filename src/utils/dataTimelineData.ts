    ...
    events: [
      {
        ...
        skills: ["#CampusPlacement", "#InterviewPreparation", "#SalesforceDeveloper", "#Varasi", "#DBMS", "Java" ]
      },
      {
        ...
        skills: ["#OffCampusPlacement", "#WebDevelopment", "#InterviewPreparation", "#React", "#rtCamp"]
      },
      {
